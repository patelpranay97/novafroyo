...
function Marquee() {
  ...
  return (
    <div className="mt-6 overflow-hidden border-y border-charcoal/25 bg-cream-soft py-1.5">
    ...
    <div className="isolate flex min-h-screen flex-col bg-cream text-charcoal">
      ...
      <section className="grain relative flex flex-1 flex-col items-center justify-center gap-12 px-6 pb-20 pt-6 text-center sm:gap-16 sm:px-12 sm:pb-32 sm:pt-10">
        ...
        <div className="flex flex-col items-center">
          <p className="rise mb-8 text-[12px] font-semibold uppercase tracking-[0.5em] text-muted">
            West Loop · Chicago
          </p>
          <h1 className="rise rise-delay-1 font-display text-[clamp(3.6rem,16.2vw,12.6rem)] leading-[0.85] tracking-[-0.01em] text-charcoal">
            NOVA
          </h1>
          <p className="rise rise-delay-2 mt-5 text-[13.2px] font-semibold uppercase tracking-[0.6em] text-charcoal sm:text-[14.4px]">
            Greek Frozen Yogurt
          </p>
        </div>

        {/* Block 3 — Cup logo seal */}
        <div className="rise rise-delay-3 flex items-center">
